...
#     rc.save_model_loss_training_metrics('AC_UNET', 'bce', )
#
# def flop_plot():
#     #group_filter_dict = {'model': 'UNET'}
#     dir_path='/home/ee487519/final_results/LOFAR_all_nonhyp_sparse/'
#     #rc = ResultsCollection('LOFAR', group_filter_dict={}, group_label_list=['model'], dir_path=dir_path)
#     rc = ResultsCollection('LOFAR', group_filter_dict={}, group_label_list=[], dir_path=dir_path)
#     #rc = ResultsCollection('LOFAR', group_filter_dict={}, group_label_list=['model', 'params'], dir_path=dir_path)
#     rc.load_groups()
#     rc.save_flops_f1()
#     rc.save_flops_auroc()
#     rc.save_flops_auprc()
#     #rc.save_flops_time()
#
# def flop_time_plot_hera():
#     dir_path='/home/ee487519/final_results/HERA_PHASE outputs/bce_lr1e-4_hyp_run_3_mnemo/'
#     rc = ResultsCollection('HERA_PHASE', group_filter_dict={}, group_label_list=[], dir_path=dir_path)
#     rc.load_groups()
#     rc.save_flops_f1()
#     rc.save_flops_auroc()
#     rc.save_flops_auprc()
#     rc.save_flops_time()
#
# def train_metrics_plot():
#     dir_path = '/home/ee487519/final_results/LOFAR_all_nonhyp_sparse/'
#     rc = ResultsCollection('LOFAR', group_filter_dict={}, group_label_list=['model'], dir_path=dir_path)
#
#     #dir_path = '/home/ee487519/final_results/HERA_PHASE outputs/bce_lr1e-4_hyp_run_3_mnemo/'
#     #rc = ResultsCollection('HERA_PHASE', group_filter_dict={}, group_label_list=['model'], dir_path=dir_path)
#     rc.save_all_training_metrics(filter_dict={}, label_list=['model'], plot_train=False)
