...
def plot_bar( query_strings=[], incl_models=[], save_name='dummy', **plot_kwargs):
    ...
    kwargs['task'] = 'bar'
    kwargs['save_name'] = f'L2_H2_bar_{save_name}'
...
def common_args():
    ...
    kwargs = dict(
        ...
        query_strings= ['experiment=="L2"  or experiment=="H2"'],
        task='bar',
        table_fields=[],
        std=True,
        params=False,
        ...
        save_name=f'dummy',
        save_path=f'/home/ee487519/PycharmProjects/RFI-NLN/reporting/thesis_results/L2_H2',
    )
    return kwargs
