...
def common_L2_kwargs(min_f1=0.5, task='train'):
    ...
    kwargs = dict(
        ...
        save_name=f'dummy',
        save_path=f'/home/ee487519/PycharmProjects/RFI-NLN/reporting/thesis_results/L2',
    )
    return kwargs
...
#        fontsize=30, figsize=(20,15), legend_bbox=(0.65, 1.0), layout_rect=(0.05, 0.05, 0.5, 0.5))
# HALF SIZE
...
# #---------------------------
# # FULL SIZE
# bubble('val_auprc', 'test_auprc', xlabel='Validation AUPRC', ylabel='Test AUPRC', fontsize=40)
# HALF SIZE
...
# #---------------------------
# # FULL SIZE
# bubble('test_auroc', 'test_auprc', xlabel='Test AUROC', ylabel='Test AUPRC', fontsize=40)
...
# eachmodel
# table(table_fields=['test_auroc', 'test_f1', 'test_auprc', 'val_auprc'], std=True, save_name='table_metrics')
