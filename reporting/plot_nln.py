...
test_data_recon = patches.reconstruct(test_data, args.raw_input_shape, args.patch_x, args.patch_y)
...
neighbour_0_recon = patches.reconstruct(neighbour_0, args.raw_input_shape, args.patch_x, args.patch_y)


neighbour_10 = neighbours[:, 10, ...]
#neighbour_10_recon = patches.reconstruct(neighbour_10, args)
neighbour_10_recon = patches.reconstruct(neighbour_10, args.raw_input_shape, args.patch_x, args.patch_y)

neighbour_19 = neighbours[:, 19, ...]
#neighbour_19_recon = patches.reconstruct(neighbour_19, args)
neighbour_19_recon = patches.reconstruct(neighbour_19, args.raw_input_shape, args.patch_x, args.patch_y)


combined_recon = np.clip(nln_error_recon, nln_error_recon.mean() + nln_error_recon.std() * 5, 1.0) * np.array(
