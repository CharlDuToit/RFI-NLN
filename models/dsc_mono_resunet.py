...
def DSC_MONO_RESUNET(input_shape, height, filters, dropout, kernel_regularizer, activation, final_activation, bn_first, **kwargs):
    """
...
def freeze_DSC_MONO_RESUNET(model: tf.keras.Model):
